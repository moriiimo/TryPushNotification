...
- (void)postNotifyBadge: (NSDictionary *)badge
{
    // 通知を作成する http://iphone-tora.sakura.ne.jp/nsnotificationcenter.html
    NSNotification *n = [NSNotification notificationWithName:@"Tuchi" object:self userInfo:badge];
    // 通知実行！この通知はどのクラスでも拾える。
